-- Keep database MIME enforcement aligned with the application file validator.
...
begin
  ...
  if asset_mime_type = 'application/octet-stream' or asset_mime_type !~ '^(image/(avif|gif|jpeg|png|svg\+xml|webp|vnd\.adobe\.photoshop|x-photoshop)|font/(otf|sfnt|ttf|woff|woff2)|application/(illustrator|pdf|postscript|vnd\.adobe\.illustrator|vnd\.adobe\.photoshop|x-illustrator|x-photoshop|zip)|text/(plain|markdown|x-markdown))$' then
