        ...
        return (
          ...
          >
            ...
            >
              ...
              <summary
                className="cursor-pointer list-none px-1 py-5 pr-20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-inset sm:pr-1 [&::-webkit-details-marker]:hidden"
                onClick={(event) => {
                  const details = event.currentTarget.closest("details");
                  if (details) rememberTypographyFamilyPosition(details);
                }}
              >
                <span className="grid w-full gap-5 sm:grid-cols-[minmax(8rem,0.8fr)_minmax(0,2fr)]">
                  <span
                    aria-hidden="true"
                    className="self-center text-7xl leading-none sm:text-8xl"
              ...
              <div className="px-1 pb-6" data-slot="typography-family-panel">
                <div className="flex flex-col gap-5">
                  {semanticRows.map(({ font, label }, index) => {
                    ...
                    return (
                      <div
                        className="grid items-baseline gap-3 py-2 sm:grid-cols-[minmax(0,1fr)_auto]"
