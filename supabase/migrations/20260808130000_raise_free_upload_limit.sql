-- Allow both Free and Premium portals to upload individual files up to 50 MiB.
-- The Free total remains 100 MiB shared by all of an owner's Free portals;
-- Premium keeps 2 GiB dedicated to each upgraded portal.
